...
export function ClosetDrawer() {
  ...
  const { closetItems, removeFromCloset, addToCart, clearCloset } = useStore()
          ...
          {closetItems.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">Keep items in your closet for future consideration</p>
              ...
              <div className="border-t pt-4">
                <div className="space-y-2">
                  <Button asChild className="w-full" onClick={() => setIsOpen(false)}>
                    <Link href="/closet">View Full Closet</Link>
                  </Button>
                  <Button variant="ghost" size="sm" className="w-full text-muted-foreground" onClick={clearCloset}>
                    Clear Closet
                  </Button>
                </div>
              </div>
